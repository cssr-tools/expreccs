...
INJS${i} G1 ${dic['reference_wellijk'][i][0]} ${dic['reference_wellijk'][i][1]} 1* GAS /
% else:
INJR${i-len(dic["site_wellijk"])} G1 ${dic['reference_wellijk'][i][0]} ${dic['reference_wellijk'][i][1]} 1* GAS /
% endif
% endfor
/
COMPDAT
