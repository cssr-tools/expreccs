...
PERMX PERMY /
/
% if dic["fault_regional"][2]*dic["fault_site"][2][0] != 1:
...
/
% endif
% if dic["fault_regional"][3]*dic["fault_site"][2][1] != 1:
...
----------------------------------------------------------------------------
OPERATE
PORV 1 ${dic['reference_num_cells'][0]} 1 1 2* ADDX PORV ${1.*dic["regional_bctype"][1]/(dic['reference_num_cells'][0]*dic['reference_num_cells'][2])}/
PORV ${dic['reference_num_cells'][0]} ${dic['reference_num_cells'][0]} 1 ${dic['reference_num_cells'][1]} 2* ADDX PORV ${1.*dic["regional_bctype"][2]/(dic['reference_num_cells'][1]*dic['reference_num_cells'][2])} /
PORV 1 ${dic['reference_num_cells'][0]} ${dic['reference_num_cells'][1]} ${dic['reference_num_cells'][1]} 2* ADDX PORV ${1.*dic["regional_bctype"][3]/(dic['reference_num_cells'][0]*dic['reference_num_cells'][2])} /
PORV 1 1 1 ${dic['reference_num_cells'][1]} 2* ADDX PORV ${1.*dic["regional_bctype"][4]/(dic['reference_num_cells'][1]*dic['reference_num_cells'][2])} /
/ 
% endif
----------------------------------------------------------------------------
PROPS
...
INJS${i} G1 ${dic['reference_wellijk'][i][0]} ${dic['reference_wellijk'][i][1]} 1* ${'GAS 'if dic['inj'][0][1][2*i] > 0 else 'WAT'} /
% else:
INJR${i-len(dic["site_wellijk"])} G1 ${dic['reference_wellijk'][i][0]} ${dic['reference_wellijk'][i][1]} 1* ${'GAS 'if dic['inj'][0][1][2*i] > 0 else 'WAT'} /
% endif
% endfor
/
COMPDAT
% for i in range(len(dic['reference_wellijk'])):
% if i < len(dic["site_wellijk"]):
INJS${i} ${dic['reference_wellijk'][i][0]} ${dic['reference_wellijk'][i][1]} ${dic['reference_wellijk'][i][2]} ${dic['reference_wellijk'][i][3]} OPEN 2* 0.2 /
% else:
INJR${i-len(dic["site_wellijk"])} ${dic['reference_wellijk'][i][0]} ${dic['reference_wellijk'][i][1]} ${dic['reference_wellijk'][i][2]} ${dic['reference_wellijk'][i][3]} OPEN 2* 0.2 /
% endif
% endfor
/
